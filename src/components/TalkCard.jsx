...
const TalkCard = (props) => {
  ...
  return (
      <div className='bg-gray-950 card-size rounded-l-3xl flex flex-col overflow-y-scroll scrollbar overflow-x-hidden border border-white'>
          <div className="border-2 p-12 rounded-tl-3xl flex h-20 flex-row  w-full items-center justify-around">
...
export const AIBubble = (props) => {
  return (
    <div className='w-2/3 bg-blue-950 h-auto font-bold text-white p-4 m-5 rounded-2xl border border-white'>
